...
private val sampleWeather = WeatherData(
    ...
    weekMaxC = 34,
    hourly = listOf(
        HourEntry("Now", 31, 0, 0),
        HourEntry("8 AM", 32, 1, 0),
        HourEntry("9 AM", 33, 0, 0),
        HourEntry("10 AM", 34, 0, 0),
        HourEntry("11 AM", 33, 2, 10),
        HourEntry("12 PM", 31, 3, 20),
        HourEntry("1 PM", 29, 61, 40),
        HourEntry("2 PM", 27, 80, 55),
    ),
    aqi = 42,
    aqiLabel = "Good",
