...
- [ ] Not yet uploaded to any Play Console track. Next step: upload to Internal Testing first (per the corrected sequencing established after versionCode 11's target-SDK policy-check surprise — see the "Discovered 2026-08-03" entry above), then promote up through Closed Testing → Production once ready.
